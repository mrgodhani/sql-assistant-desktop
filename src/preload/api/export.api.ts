...
export const exportApi = {
  ...
  exportCsv: (payload: string): Promise<void> => ipcRenderer.invoke('export:csv', payload),

  exportExcel: (payload: string): Promise<void> => ipcRenderer.invoke('export:excel', payload),
